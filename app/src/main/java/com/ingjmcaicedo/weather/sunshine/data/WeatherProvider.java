package com.ingjmcaicedo.weather.sunshine.data;// /*
...
//                 throw new UnsupportedOperationException("Unknown uri: " + uri);
     ...
     public int update(
         ...
         switch (match) {
             case WEATHER: {
                 rowsNumber = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values, selection, selectionArgs);
                 break;
             }
             case LOCATION: {
                 rowsNumber = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                 break;
             }
             default:
                 throw new UnsupportedOperationException("Unknown uri: " + uri);
