...
import static com.ingjmcaicedo.weather.sunshine.data.WeatherContract.WeatherEntry;

/**
 * Created by IngJmCaicedo on 12/9/14.
 */
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... strings) {
        ...
        try {
            ...
            builder.appendQueryParameter("cnt", Integer.toString(cnt));
        ...
        try {
            getWeatherDataFromJson(forecastJsonStr, cnt, cityName);
    ...
    private long addLocation(String location, String cityName, double lat, double lon) {
...
//                null);
        ...
        if (cursor.moveToFirst()) {
            ...
            locationValues.put(WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING, location);
